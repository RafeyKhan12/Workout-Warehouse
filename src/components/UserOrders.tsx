  ...
  return (
    <div className="bg-zinc-950 min-h-screen text-white px-6 lg:px-20 py-16">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-12 tracking-tight">MY ORDERS</h1>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col justify-between items-start md:items-end">
                  ...
                  {order.paymentStatus !== "paid" ? (
                    ...
                    <button className="mt-6 bg-[#d4af37] text-black font-semibold px-6 py-3 rounded-xl hover:bg-[#c5a028] transition-all duration-300">
                      PAYMENT COMPLETED
                    </button>
                  )}
                </div>
